...
<?php
	$query="SELECT * FROM promocion WHERE now() BETWEEN fechai and fechaf";
	foreach ($conexion->query($query) as $fila)
	{
		echo "<div><img date-u='image' src='images/promociones/".$fila['imagen']."' width='100%' /></div>";
	}
?>
...
<!--Imagenes de 680 * 300, todas las promociones, añadir a la base de datos 10 promociones vigentes y otras no-->